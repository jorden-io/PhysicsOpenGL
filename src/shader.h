...
namespace gl
{
    ...
    public:
        unsigned int ID;
        void set_paths(const char *vs_path, const char *fs_path)
        {
            ...
            try
            {
                ...
                v_shader_stream << vs_file.rdbuf();
                f_shader_stream << fs_file.rdbuf();
                // close file handlers
                vs_file.close();
                fs_file.close();
                // convert stream into string
                vertexCode = v_shader_stream.str();
                fragmentCode = f_shader_stream.str();
            }
